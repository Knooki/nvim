...
_G.packer_plugins = {
  ...
  ["jedi-vim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/jedi-vim",
  ...
  ["neodev.nvim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/neodev.nvim",
  ...
  ["vim-dadbod"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/vim-dadbod",
    url = "https://github.com/tpope/vim-dadbod"
  },
  ["vim-dadbod-completion"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/vim-dadbod-completion",
    url = "https://github.com/kristijanhusak/vim-dadbod-completion"
  },
  ["vim-dadbod-ui"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/vim-dadbod-ui",
