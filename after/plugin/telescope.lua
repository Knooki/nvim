...
vim.keymap.set('n', '<leader>sf', builtin.treesitter, { desc = '[S]earch functions'})
vim.keymap.set('n', '<leader>scf', builtin.current_buffer_fuzzy_find, { desc = '[S]earch functions'})
